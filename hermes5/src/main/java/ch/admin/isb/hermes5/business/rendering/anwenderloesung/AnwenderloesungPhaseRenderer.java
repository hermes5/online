...
public class AnwenderloesungPhaseRenderer extends AnwenderloesungModelElementRenderer {
    ...
    public boolean isResponsible(AbstractMethodenElement modelElement) {
        return modelElement instanceof Phase;
    }
    ...
    public String renderModelElement(AbstractMethodenElement modelElement, LocalizationEngine localizationEngine,
        ...
        ctx.put("titleKey", "al_doc_type_phase");

        return velocityAdapter.mergeTemplates(ctx, "al_header.vm", "phase.vm", "al_footer.vm");
    }
}
