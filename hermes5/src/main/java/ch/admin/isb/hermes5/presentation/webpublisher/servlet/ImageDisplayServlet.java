 ...
 * expected call /webpublisher/imagedisplay/123 where 123 is the id of the image
 */
@WebServlet("/webpublisher/imagedisplay/*")
public class ImageDisplayServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        long imageid = Long.parseLong(st.nextToken());
        String display = imageDisplayController.display(webPublisherFacade.getImage(imageid));
