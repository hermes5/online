...
public class AnwenderloesungModulRenderer extends AnwenderloesungModelElementRenderer {
    ...
    public boolean isResponsible(AbstractMethodenElement modelElement) {
        return modelElement instanceof Modul;
    }
    ...
    public String renderModelElement(AbstractMethodenElement modelElement, LocalizationEngine localizationEngine,
        ...
        ctx.put("titleKey", "al_doc_type_modul");

        return velocityAdapter.mergeTemplates(ctx, "al_header.vm", "modul.vm", "al_footer.vm");
    }
}
