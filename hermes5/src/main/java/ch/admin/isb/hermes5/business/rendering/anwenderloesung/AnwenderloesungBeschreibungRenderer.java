...
public class AnwenderloesungBeschreibungRenderer extends AnwenderloesungModelElementRenderer {
    ...
    public boolean isResponsible(AbstractMethodenElement modelElement) {
        return modelElement instanceof Beschreibung;
    }
    ...
    public String renderModelElement(AbstractMethodenElement modelElement, LocalizationEngine localizationEngine,
        ...
        return velocityAdapter.mergeTemplates(ctx, "al_header.vm", "beschreibung.vm", "al_footer.vm");
    }
}
