...
public class AnwenderloesungXMLModelIndexPageRenderer implements Serializable {
    ...
    public String renderXMLModelIndexPage(AnwenderloesungRenderingContainer container,
            LocalizationEngine localizationEngine) {

        Map<String, Object> ctx = new HashMap<String, Object>();
        ctx.put("c", container);
        ctx.put("menu", "xmlmodel");
        ctx.put("lang", localizationEngine.getLanguage());
        ctx.put("pathprefix", "../../");
        ctx.put("l", localizationEngine);
        ctx.put("StringUtil", StringUtil.class);
        return velocityAdapter.mergeTemplates(ctx, "al_header.vm", "xmlmodel_index.vm", "al_footer.vm");
    }
}
