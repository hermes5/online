...
public class OnlinePublikationRolleRenderer extends OnlinePublikationRenderer {
    ...
    public String renderModelElement(AbstractMethodenElement methodenElement, List<MenuItem> adjustedMenu,
        ...
        initContext.put("relationshipTableRecords", relationshipTablePreprocessor.preprocess(
                ((Rolle) methodenElement).getRelationshipTableRecords(), localizationEngine));
        return velocityAdapter.mergeTemplates(initContext, OP_HEADER_AND_MENU, "rolle.vm", OP_FOOTER);
    }
}
