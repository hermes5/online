...
@WebServlet("/anwenderloesung/logo/*")
public class LogoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        byte[] logo = szenarioWizardContext.getSzenarioUserData().getLogo();
        String logoFilename = szenarioWizardContext.getSzenarioUserData().getLogoFilename();
        String mimeType = mimeTypeUtil.getMimeType(logoFilename);
        servletSupport.sendFile(resp, mimeType, logo);
    }
