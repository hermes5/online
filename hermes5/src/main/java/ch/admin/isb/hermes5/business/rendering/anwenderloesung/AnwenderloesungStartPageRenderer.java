...
public class AnwenderloesungStartPageRenderer implements Serializable {
    ...
    public String renderStartPage(AnwenderloesungRenderingContainer container, LocalizationEngine localizationEngine) {
        ...
        return velocityAdapter.mergeTemplates(ctx, "al_header.vm", "start_page.vm", "al_footer.vm");
    }
}
