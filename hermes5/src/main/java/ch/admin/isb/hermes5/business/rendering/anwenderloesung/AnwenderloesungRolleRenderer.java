...
public class AnwenderloesungRolleRenderer extends AnwenderloesungModelElementRenderer {
    ...
    public boolean isResponsible(AbstractMethodenElement modelElement) {
        return modelElement instanceof Rolle;
    }
    ...
    public String renderModelElement(AbstractMethodenElement modelElement, LocalizationEngine localizationEngine,
        ...
        ctx.put("titleKey", "al_doc_type_rolle");

        ctx.put("relationshipTableRecords", relationshipTablePreprocessor.preprocess(
                ((Rolle) modelElement).getRelationshipTableRecords(), localizationEngine));
        return velocityAdapter.mergeTemplates(ctx, "al_header.vm", "rolle.vm", "al_footer.vm");
    }
}
